...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {基于面部表情、语音、头部姿态的在线实时数字人手势驱动},
    en / title           = {Real-time Online Digital Human Gesture Drive Based on Facial Expression, Speech, and Head Pose},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {随语手势生成, 数字人驱动, 面部捕捉, 多模态学习},
